...
@section('content')
                    ...
                    <div class="owl-carousel owl-theme owl-slider">
                        @foreach($sliders as $slider)
                            <a class="item" href="{{ $slider->code }}">
                                <img src="{{ $slider->code5 }}" alt="{{ $slider->name }}" width="1349" height="529" fetchpriority="{{ $loop->first ? 'high' : 'low' }}" loading="{{ $loop->first ? 'eager' : 'lazy' }}" />
    ...
    @if(isset($textAbout) && !empty($textAbout))
        <section class="container-fluid  about-section p-0 position-relative">
                    ...
                    <div class="col-md-6 pl-md-0 col-12">
                        <div class="row">
                            <div class="col-md-10 col-12 p-0">
                                <h2 class="abou-company">{{ $textAbout->name }}</h2>
                                <div class="d-block sub-title">
                                    {{ $textAbout->code }}
                                </div>
                                <div class="d-block about-text mt-3 mb-2">
            ...
            <img src="{{ $textAbout->code5 }}" class="img-fluid img-about" alt="{{ $textAbout->name }}" width="469" height="434"/>
        </section>
    @endif
