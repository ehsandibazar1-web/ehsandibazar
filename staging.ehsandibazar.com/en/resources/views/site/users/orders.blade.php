        ...
        <div class="uk-container uk-containcer-center uk-margin-large-top uk-margin-large-bottom">
            <div class="uk-grid" uk-grid>
                ...
                <div class="uk-width-3-4@m uk-background-muted uk-padding">
                            ...
                            <table class="cart-page-table orders-table uk-table uk-table-hover uk-table-divider">
                                ...
                                @foreach($orders as $itemOrder)
                                    ...
                                    <span class="currencySymbol">
                                        ...
                                        <td>{{ isset($itemOrder->shipping_code) && !empty($itemOrder->shipping_code) ? $itemOrder->shipping_code : 'Waiting for the shipment code' }}</td>
                    ...
                    @else
                        <div class="uk-alert uk-alert-warning">You have never made a purchase!</div>
                    @endif
                </div>
            </div>
        </div>
                                        ...
                                        <td class="text-center">
                                            @if(!$orderItems->order->user->isColleague())
                                                @if(isset($orderItems->amount_discount) && $orderItems->amount_discount > 0 && !empty($orderItems->amount_discount) && !empty($orderItems->discount))
                                                    ...
                                                    -( {!!   unserialize($orderItems->discount)->baseon == \App\Utility\DiscountType::cent ? '<b style=color:red>%</b>'.unserialize($orderItems->discount)->cent : number_format(unserialize($orderItems->discount)->cent).' toman '  !!}
                                                    )
                        ...
                        <div class="row"><br>
                            <div class="col-md-6">
                                ...
                                @if(!$orderItems->order->user->isColleague() && !empty($totalDiscount))
                                    <div class="last-activity">
                                        <p> discount :
                                            {{ number_format(abs($totalDiscount))."toman" }}
                                        </p>
                                    </div>
                                ...
                                <div class="last-activity">
                                    ...
                                    <p>
                                        ...
                                        @if($itemOrder->shippingCost > 0 && !is_null($itemOrder->shippingCost) )
                                            ...
                                            {!! number_format($totalPrice).' toman' !!}
                                        @else
                                            {!! number_format($itemOrder->total_discount).' toman' !!}
                                        @endif
                                    </p>
