...
@section('site.css')
    <link rel="stylesheet" type="text/css" href="{{ url('') }}/site_theme/css/compare.css"/>
@endsection
...
@section('content')
    <div class="container">
        <section class="o-page">
            ...
            <div class="o-headline"><span>compare list {{ $category->title }} </span></div>
                            ...
                            @foreach($products as $product)
                                <div class="c-compare__list-value js-compare-product">
                                    <div class="c-compare__img">
                                        ...
                                        <a class="btn-primary"
                                           href="{{ $product->path() }}">
                                            View and buy the product</a></div>
                                ...
                                <div class="c-compare__add add-compare">
                                    <button href="#" class="c-compare__placement" data-toggle="modal"
                                        ...
                                        <i class="fa fa-plus add_compare"
                                           aria-hidden="true"></i>
                                        Click to add product to comparison list
                                        do
                                    </button>
                                    <button type="button" class="btn-primary btn-primary--gray" data-toggle="modal"
                                            data-target="#myModal">Add goods to compare
                                    </button>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="c-form-compare-selector__col">
                                    ...
                                    @else
                                        <span class="label label-info">
                                            There are no products to choose from and compare, please check another category
                                        </span>
                                    @endif
                                </div>
                            </div>
