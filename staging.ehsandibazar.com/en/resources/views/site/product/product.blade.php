...
@section('site.css')
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('') }}/site_theme/css/custom-site.css"/>
    <link href="{{ url('') }}/site_theme/css/jquery.fancybox.min.css" rel="stylesheet">
...
{{--                                @endcomponent--}}
{{--                            </li>--}}
                            <li><span class="v-link">{{ $product->viewCount }}</span> View</li>
                    ...
                    <div class="col-md-5 col-12   text-center">
                        <div class="box-price">
                            ...
                            <li>
                                ...
                                <span class="cost-pro"
                                      id="ajax-price">{{ count($product->variations->toArray())  <= 0 || $count <= 0  ? 'unavailable' : null}}</span>
                                <span class=""
                            ...
                            @if((auth()->check() && !auth()->user()->isColleague()) || !auth()->check())
                                @if(\App\Utility\DiscountType::hasDiscount($product) == true)
                                    <div class="offer-product">
                                        <b>{{ \App\Utility\DiscountType::showCentDiscount($product) }} Discount</b></div>
                                @endif
                            @endif
            ...
            <div class="col-12 col-md-12 p-0">
                ...
                <div class="product-desc-header">
                    <ul class="p-0">
                        ...
                        <li id="prt"><a href="javascript:void(0)">Product preview</a></li>
                        ...
                        <div class="reviews-qa-tab">
                            <div class="qa-review-header">
                                <ul>
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" class="active" id="question-btn">Comments</a>
                                    </li>
                                </ul>
                            </div>
...
{{--                                    <img src="{{ asset('site_theme/loading.gif') }}" alt="loading" id="loading-image">--}}
                                    <div>
                                        {!! $product->video[0]->url !!}
                                    </div>
                                @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="sharing-socials clearfix">
                                <p class="sharing-socials-label">share</p>
                            ...
                            <div class="sharing-shortlink clearfix">
                                <label for="shortlink">Page address</label>
...
@section('site-js')
    ...
    <script src="{{ url('') }}/site_theme/js/jquery.lazyload.js"></script>
    <script src="{{ url('') }}/site_theme/js/jquery.fancybox.min.js"></script>
    <script src="{{ url('') }}/site_theme/js/zoom.js"></script>
    <script>
