            ...
            <div class="row">
                <div class="main-content col-12 col-md-7 col-lg-5 mx-auto">
                    <div class="account-box">
                        ...
                        <div class="account-box-title text-center"> Password recovery | {{ env('SITE_NAME_FA') }}</div>
                        <div class="account-box-content">
                            ...
                            <form method="POST" action="{{ route('reset.password.send.sms') }}" class="form-account">
                                ...
                                <div class="form-account-row">
                                    ...
                                    <input class="input-field" type="email" name="email" autocomplete="mobile" value="{{ old('mobile') }}" placeholder="email...." autofocus>
                                </div>
