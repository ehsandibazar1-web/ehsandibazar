...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="{{ route('log-viewer::dashboard') }}" class="navbar-brand mr-0">
            <i class="fa fa-fw fa-book"></i> گزارشات
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item {{ \Illuminate\Support\Facades\Route::is('log-viewer::dashboard') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Route::is('log-viewer::logs.list') ? 'active' : '' }}">
                    <a href="{{ route('log-viewer::logs.list') }}" class="nav-link">
                        <i class="fa fa-archive"></i> خطا ها
                    </a>
                </li>
            </ul>
        </div>
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            <p class="text-muted pull-left">
               گزارش ها - <span class="badge badge-info">ورژن {{ log_viewer()->version() }}</span>
            </p>

            <p class="text-muted pull-right"><i class="fa fa-heart"></i>
                توسعه توسط وب پن تست
            </p>
        </div>
    </footer>
