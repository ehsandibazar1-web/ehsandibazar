        ...
        <div class="col-md-12">
            <div class="form-group ">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input id="thumbnail3" class="form-control input-first-gallery" type="text"
                               value="{{ isset($findBrand) && count($findBrand->image) > 0 &&  isset($findBrand->image[0]) ?   $findBrand->image[0]->url : null }}"
                               name="filepath[]">
                ...
                <div class="col-md-11 text-center">
                    @if (isset($findBrand))
                        @if(count($findBrand->image) > 0 && isset($findBrand->image[0]))

                                <img class="div-first-gallery" id="holder3"
                                     src="{{ $findBrand->image[0]->url }}"
