        ...
        <div class="form-group">
            <div class="">
                ...
                <input id="thumbnail3" class="form-control" type="text"
                       name="filepath[]"
                       value="{{ isset($findIdProducts->image[1]) && !empty($findIdProducts->image[1])  ? $findIdProducts->image[1]->url : null }}">
            </div>
            ...
            <br>
            @if(isset($findIdProducts) && isset($findIdProducts->image[1]) && count($findIdProducts->image) >=2)
                <img src="{{  $findIdProducts->image[1]->url  }}" id="holder2"
