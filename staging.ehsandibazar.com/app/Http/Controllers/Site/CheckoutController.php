...
class CheckoutController extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($basket,$basket->totalPrice)) {
            $shippingCost = $this->checkSessionShippingCost($basket->totalPrice);
        }
        $freeShippingTwo = self::$freeShippingTwo;
        return view('site.checkout.index', compact('shippingCost','showDetails', 'user', 'sessionAddress', 'tax', 'basket', 'title', 'freeShippingTwo'));
    }
