...
class RequestProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.request-product.index', compact('requestProduct'));
    }

    public function create()
    {
        $allProduct = $this->allProduct;
        return view('panel.request-product.create', compact('allProduct'));
    }
    ...
    public function edit($id)
    {
        if (is_numeric($id)) {
            ...
            return view('panel.request-product.create', compact('videos', 'images', 'allProduct', 'title', 'findIdProducts'));
        } else {
    ...
    public function store(Request $request)
    {
        ...
        if ($saveData instanceof Requestproduct) {
           // $this->user->decrement('credit');
            ...
            return redirect()->route('panel.request.product');
        } else {
    ...
    public function ajaxRequestProduct(Request $request)
    {
        ...
        $view = view('panel.request-product.ajax.found-product', compact('findProductRequest'))->render();
