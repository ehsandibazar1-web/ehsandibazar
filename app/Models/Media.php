...
class Media extends Model
{
    ...
    // ownerRecord() (کدام Article/Page این تصویر را به‌عنوان تصویر شاخص دارد) عمداً حذف شد تا وقتی
    // مدل‌های محتوا همگرا منتقل شوند (موج ۴). فقط AgentAuditService از آن استفاده می‌کرد (موج ۵).
}
