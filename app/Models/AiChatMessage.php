 ...
 * درخواستِ عملی (تولید/بهبودِ یک فیلد یا ترجمه) طبقه‌بندی شود، ردیفِ assistantِ متناظر به همان
 * AiGenerationِ ساخته‌شده لینک می‌شود (related_generation_id) تا وضعیت/نتیجه‌اش داخلِ رشته‌ی
 * گفتگو دیده شود.
 */
