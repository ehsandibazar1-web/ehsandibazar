...
class AiGeneration extends Model
{
    ...
    // knowledgeEntries() (نمایشِ «Knowledge used») عمداً حذف شد تا Knowledge Base/RAG منتقل شود
    // (تصمیمِ فعلاً-بی‌خیالِ-RAG). وقتی KB آمد، این رابطه و pivotِ ai_generation_knowledge_entry برمی‌گردد.
