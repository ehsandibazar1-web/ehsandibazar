...
/**
 * مدیریتِ «ورودی‌های دانش» — پورتِ Knowledge Entries سایتِ انگلیسی. CRUDِ ادمین‌محور روی مدلِ
 * App\Models\KnowledgeEntry. storefront دست‌نخورده است. مسیرِ ایندکسِ برداری (RAG/embedding)
 * فعلاً stub است (نگاه کنید به App\Services\Rag\IndexingService)، پس هیچ تماس شبکه‌ای انجام
 * نمی‌شود؛ فایل‌ها ذخیره می‌شوند ولی embed نمی‌شوند.
 */
