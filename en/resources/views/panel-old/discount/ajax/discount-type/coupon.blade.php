<div class="form-group">
    <label for="cname" class="control-label col-lg-2">@lang('cms.coupon-expire_date') <b style="color: red;">*</b></label>
    <div class="col-lg-10">
...
<div class="form-group">
    <label for="cname" class="control-label col-lg-2">@lang('cms.code-coupon') <b style="color: red;">*</b></label>
    <div class="col-lg-10">
