<h3 class="h3-details">@lang('cms.file')
...
<p class="alert alert-default border-right-dark"> لطفا اولین ویدیو یا ویس را بعنوان پیش نمایش وارد نمایید و فایل دوم فایل کامل باشد</p>
...
<div class="form-group">
    ...
    <div class="col-lg-12">
            <span class="btn btn-info pull-right" id="previousToPic">
               @lang('cms.previous')
            </span>
    </div>
