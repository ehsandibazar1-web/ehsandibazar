        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="{{ route('log-viewer::dashboard') }}" class="navbar-brand">
                    <i class="fa fa-fw fa-book"></i> گزارش ها
                </a>
            </div>
    ...
    <footer class="main-footer">
        <div class="container">
            <p class="text-muted pull-left">
                گزارش خطا - <span class="label label-info">version {{ log_viewer()->version() }}</span>
            </p>
            <p class="text-muted pull-right">
                Created with <i class="fa fa-heart"></i> توسط وب پن تست <sup>&copy;</sup>
            </p>
        </div>
    </footer>
